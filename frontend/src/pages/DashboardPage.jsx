...
const DashboardPage = () => {
  ...
  const declarations = [
    { year: '2024', status: 'Brouillon', color: 'bg-orange-100 text-orange-800', action: 'Reprendre' },
    { year: '2023', status: 'Terminée', color: 'bg-green-100 text-green-800', action: 'Télécharger' },
    { year: '2022', status: 'Terminée', color: 'bg-green-100 text-green-800', action: 'Télécharger' },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {declarations.map(decl => (
          <div key={decl.year} className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex flex-col justify-between">
            <div>
